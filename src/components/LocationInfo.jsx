const LocationInfo = ({ location }) => {
    ...
    return (<alticle className=" max-w-[50vw]  min-w-[300px] flex flex-col justify-center items-center shadow  shadow-black  rounded-xl  mb-5 mt-5 mx-auto p-3 bg-[#072226]">
